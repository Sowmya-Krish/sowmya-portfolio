        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-12" id="intro">
            ...
            <div className="text-center" id="social-cont">
              <a
                target="_blank"
                href="https://mail.google.com/mail/u/0/?hl=en-GB&tf=cm&fs=1&to=sowmikrish.crazy@gmail.com"
              >
                <i class="fa-regular fa-envelope"></i>
              </a>
              <a target="_blank" href="https://github.com/Sowmya-Krish">
                <i class="fa-brands fa-github"></i>
              </a>
              <a
                target="_blank"
                href="https://www.linkedin.com/in/sowmya-krishnan-140105243?trk=contact-info"
              >
